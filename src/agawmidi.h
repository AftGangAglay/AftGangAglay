...
enum aga_result aga_mkmididev(struct aga_mididev* dev) {
	unsigned res, id;
...
enum aga_result aga_killmididev(struct aga_mididev* dev) {
	if(!dev) return AGA_RESULT_BAD_PARAM;
...
enum aga_result aga_mkmidi(
		struct aga_mididev* dev, struct aga_midi* midi, void* buf,
		aga_size_t len) {
...
enum aga_result aga_killmidi(struct aga_mididev* dev, struct aga_midi* midi) {
	if(!dev) return AGA_RESULT_BAD_PARAM;
	if(!midi) return AGA_RESULT_BAD_PARAM;
...
enum aga_result aga_midi_play(struct aga_mididev* dev, struct aga_midi* midi) {
	unsigned err;
