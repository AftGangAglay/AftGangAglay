...
LIBTIFF_SOURCES = tif_aux.c tif_close.c tif_codec.c tif_compress.c tif_dir.c \
					tif_dirinfo.c tif_dirread.c tif_dirwrite.c tif_dumpmode.c \
					tif_error.c tif_fax3.c tif_getimage.c tif_jpeg.c \
					tif_flush.c tif_lzw.c tif_next.c tif_open.c \
					tif_packbits.c tif_predict.c tif_print.c tif_read.c \
					tif_swab.c tif_strip.c tif_thunder.c tif_tile.c \
...
LIBTIFF_CFLAGS = -D_SVID_SOURCE -w -Ivendor/support
...
$(MKG3STATES_OBJECT): CFLAGS += $(LIBTIFF_CFLAGS)

$(LIBTIFF): $(LIBTIFF_OBJECTS)

$(LIBTIFF_OBJECTS): CFLAGS = $(LIBTIFF_CFLAGS)
